      ...
      <div class="row">
        ...
        <?if($session_role=="admin" || ($session_role=="teacher" && $instructorId==$session_id)){?>
            ...
            <div class="row" style="margin:0px;padding:0px;">
                <div class="col-md-8" >
                    <input hidden type="text" name="courseId" value="<?echo $courseId?>" required>
                    <input style="margin:0px 15px;" type="text" name="title" class="form-control" id="exampleFormControlInput1" placeholder="Add new Announcement title" required>
                </div>
                <div class="col-md-3">
                    <input type="submit" value="Add" class="btn btn-md btn-neutral" />
                </div>
            </div>
            </form>
            <br>
          ...
          <div class="card">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  <h5 class="h3 mb-0">Announcements</h5>
                </div>
              </div>
            </div>
            <div >
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody class="list">
                    <?
                    if ($result_announcments->num_rows > 0)
                    { 
                        //successfull login
                        while($row = $result_announcments->fetch_assoc()) 
                        { 
                    ?>
                  <tr>
                    <td scope="row">
                    ...
                    <td scope="row">
                      <a class="btn btn-neutral btn-sm" href="./view_announcement.php?id=<?echo $row['id']?>">View</a>
                    </td>
                  </tr>
                  <?}
                  }?>
