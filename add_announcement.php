...
if(isset($_POST['title'])){
    ...
    $sql="insert into pssec_announcements(`id`, `title`, `content`, `timeAdded`, `courseId`) values ('$id' , '$title', '', '$timeAdded', '$courseId')";
    if(!mysqli_query($con,$sql)){echo "err2";}else{
        ?>
        <script type="text/javascript">
            window.location = "?notfId=<?echo $id?>";
        </script>
        <?
    }
}
...
if(isset($_POST['notf'])){
    ...
    $query_notf_recp= "select p.studentId as id from pssec_enrollment p where p.courseId='$courseId'"; 
        ...
        { 
            ...
            { 
                $temp_student = $row['id'];
                $sql="insert into pssec_notifications(`studentId`, `content`, `timeAdded`, `url`) values ('$temp_student', 'New Announcement Posted', '$timeAdded', './courseContent.php?courseId=$courseId')";
    ...
    if(true){
        ...
        $notfId = mb_htmlentities(($_GET['notfId']));

        $sql="update pssec_announcements set content = '$notf' where id='$notfId'";
        if(!mysqli_query($con,$sql)){echo "err2";} 
        $_SESSION['courseId'] = '';
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Send Announcement</h6>
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  
                 
                  
                  <li class="breadcrumb-item active" aria-current="page">Send Announcement</li>
          ...
          <div class="card">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  <h5 class="h3 mb-0">Send Announcement</h5>
                </div>
              </div>
            </div>
            <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <textarea type="text" name="notf" class="form-control" id="exampleFormControlInput1" placeholder="Notification Text" required></textarea>
                  </div>
