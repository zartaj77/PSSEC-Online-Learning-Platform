        ...
        <div class="card">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  <h5 class="h3 mb-0">Assessments</h5>
                </div>
              </div>
            </div>
            <div >
              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col" class="sort" data-sort="name">Weightage</th>
                  </tr>
                </thead>
                <tbody class="list">
                    <?
                    if ($result_assemssments->num_rows > 0)
                    { 
                        //successfull login
                        while($row = $result_assemssments->fetch_assoc()) 
                        { 
                    ?>
                  <tr>
                    <td scope="row">
                    ...
                    <td scope="row">
                      <div class="media align-items-center">
                        <div class="media-body">
                          <span class="name mb-0 text-sm"><?echo $row['quiz_weight']?>%</span>
                        </div>
                      </div>
                    </td>
                  </tr>
