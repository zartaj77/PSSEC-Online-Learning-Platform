...
if(isset($_POST['university'])){
    ...
    if(true){
        ...
        $sql="insert into pssec_users (`name`,`email`, `password`, `role`, `university`) values ('','$s', '$s', 'none', '$university')";
            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">New University</li>
          ...
          <div class="card">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  <h5 class="h3 mb-0">New University</h5>
                </div>
              </div>
            </div>
            <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="university" class="form-control" id="exampleFormControlInput1" placeholder="University name" required>
                  </div>
