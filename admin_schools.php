...
$query_universities= "select u.university, uni.address, uni.phone, uni.email, uni.website, uni.fb from pssec_users u LEFT OUTER join pssec_universities uni on u.university=uni.university WHERE u.university!='' and (u.portion='College/School' or uni.portion='College/School') GROUP BY u.university"; 
          ...
          <div class="row align-items-center py-4">
            ...
            <?if($session_role=="admin" || $session_role=="teacher"){?>
                <div class="col-lg-6 col-5 text-right">
                  <a href="./newSchool.php" class="btn btn-md btn-neutral">Add New School</a>
                </div>
            <?}?>
          ...
          <div class="card">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  <h6 class="text-uppercase text-muted ls-1 mb-1">Schools</h6>
                  <h5 class="h3 mb-0">Schools</h5>
                </div>
              </div>
            </div>
            <div >
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody class="list">
                  ...
                  <tr>
                    ...
                    <td>
                    <?if($row['phone']==''){?>
                             <a class="btn btn-success btn-sm" href="./admin_schools_addInfo.php?uni=<?echo urlencode($row['university'])?>">Add Info</a>
                        
                    <?}?>
                    <a class="btn btn-primary btn-sm" href="./admin_schools_gradescale.php?uni=<?echo urlencode($row['university'])?>">Grade Scale</a>
                    <a class="btn btn-warning btn-sm" href="./admin_schools_edit.php?uni=<?echo urlencode($row['university'])?>">Edit</a>
                    </td>
                  </tr>
                  <?}
                  }?>
