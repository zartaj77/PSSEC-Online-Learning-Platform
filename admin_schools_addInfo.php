...
if(isset($_POST['address'])){
    ...
    if(true){
        ...
        givePoints($con, "Updated College/School Info $title", $session_id, '30');
     
        $uni = $_GET['uni'];
        
        $sql="INSERT into pssec_universities set university='$uni', address='$address', phone='$phone', email='$email', website='$website', fb='$fb', portion='College/School'";
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Update College/School Info</h6>
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  
                 
                  <li class="breadcrumb-item"><a href="./">Colleges/Schools</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Update College/School Info</li>
          ...
          <div class="card">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  <h5 class="h3 mb-0">Update College/School Info</h5>
                </div>
              </div>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <input type="text" name="dept" class="form-control" id="exampleFormControlInput1" placeholder="College/School name" required readonly value="<?echo $_GET['uni']?>">
                  </div>
                    </div>
